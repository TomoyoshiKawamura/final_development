...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { deadline_month: @credit_card.deadline_month, deadline_year: @credit_card.deadline_year, name: @credit_card.name, number: @credit_card.number, user_id: @credit_card.user_id } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { deadline_month: @credit_card.deadline_month, deadline_year: @credit_card.deadline_year, name: @credit_card.name, number: @credit_card.number, user_id: @credit_card.user_id } }
